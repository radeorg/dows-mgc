...
public class DatabaseUtils {
    ...
    public static Object transValueDb2Obj(ColumnModel col, Object value) throws ParseException {
        ...
        if (targetType == Integer.class) {
            ...
            return Date.from(LocalDate.parse(value.toString(), DATE_FORMATTER).atStartOfDay(java.time.ZoneId.systemDefault()).toInstant());
    ...
    public static Object transValueObj2Db(Object value) {
        ...
        if (value instanceof String) {
            return value;
            // 时间戳类型转换为格式化字符串
        } else if (value instanceof Timestamp || value instanceof Timestamp) {
