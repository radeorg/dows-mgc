...
import org.dows.mgc.sql.core.model.ItemModel;
...
public class TableModelUtils {
    ...
    private static final Map<Class<?>, TableModel> TABLE_MODEL_CACHE = new ConcurrentHashMap<>();
    ...
    public static TableModel getTableModel(Class<?> clazz) {
        TableModel tableModel = TABLE_MODEL_CACHE.getOrDefault(clazz, null);
        if (tableModel != null) {
            return tableModel;
        }
        ...
        TABLE_MODEL_CACHE.put(clazz, tableModel);
        return tableModel;
    }
